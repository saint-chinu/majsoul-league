...
MANUAL_PLAYER_ANALYSIS: dict[str, tuple[str, str, str]] = {
    "流れ者金融": (
        ...
        "改善点は、リード時の局消化精度。強者ゆえに押せてしまう場面も多いので、トップ目や大きく浮いた半荘では、加点よりも局を終わらせる選択を少し増やしたい。終盤の押し返しをさらに絞ると、取りこぼしがもっと減る。",
    ),
    "ひなんじょ": (
    ...
    "鯛ofカルピス": (
        "ツモ率がトップで、勝負手を自力決着に持ち込む力がかなり強い。和了率も上位で、手が入った時にきちんとあがりまで持っていけている。反面、放銃率と放銃平均打点は重く、攻めた局の反動も大きい。",
        "強みは、ツモ決着で相手の守備を崩さずに点棒を持ってこられるところ。シーズン2、3、5でチーム優勝に絡んでいて、チーム戦でプラス役になれる期間が多い。押す局の火力と決着力はリーグ内でも上位。",
        "改善点は、攻めた時の失点管理。自分の手が十分に見える局でも、相手の打点が濃い時は放銃平均を抑える意識がほしい。特に終盤の一向聴押し、親相手の無筋連打は、あがり率より失点期待値を優先するとさらに強くなる。",
    ),
    "アリスkey": (
    ...
    "葡萄海ぶどう": (
        "平均和了点がトップで、打点を作る力が一番強く出ている。立直率も高めで、門前高打点や勝負手の破壊力があるタイプ。高い手を仕上げた時の圧は強い。一方で累計スコアと平均順位は苦しく、あがれなかった局の失点や着順落ちが響いている。",
        "強みは、1回の和了で局面をひっくり返せること。安い手を細かく刻むより、打点を見て一撃で順位を変える麻雀になっている。平均和了点トップはかなりはっきりした個性で、相手からすると常に高打点を警戒しないといけない存在。伸ばす方向性は見えている。",
        "改善点は、打点志向と守備のバランス。高打点を狙う価値はあるが、和了率・放銃率・トップキープ率が下位なので、勝負手ではない局の撤退を増やしたい。高打点を狙う局と、速度か守備に寄せる局の切り替えを早めると、平均和了点の強みを残したまま失点を減らせる。",
    ),
}
