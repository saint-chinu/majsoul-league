...
MANUAL_PLAYER_ANALYSIS: dict[str, tuple[str, str, str]] = {
    "流れ者金融": (
        "累計トップの支配型。獲得スコア4,717.0、平均順位1.84、1位率41.91%、ラス回避率74.28%で、まだ全体の軸はほぼ崩れていない。和了率32.39%、副露率35.61%、先制テンパイ率35.14%、テンパイ維持率21.54%と、門前だけでも副露だけでもなく、どの入口からでも局に触れる。トップ滞在率45.79%も高く、半荘のかなり長い時間をリード側で進めている。シーズン10途中分が入って少し数字は落ちたが、それでもなお別格のトップ維持力が残っている。",
        "強みは、攻撃量の多さと放銃の軽さが同居していること。これだけ局参加して放銃率14.97%、放銃平均8,813.6点に収まっているのはかなり強い。リーチの質はおすすめ寄り84.75%、非推奨15.25%、平均スコア2.94で、曲げる局の選別もまだ上位。副露の質スコアは-0.09で、鳴きが極端に高得点化しているわけではないが、速度で相手の大物手を成立前に潰す働きが大きい。トップキープ率36.16%もリーグ最高で、守るトップというより、リード後も局を終わらせに行くトップ。",
        "改善点は、勝っている半荘の終盤をもう一段だけ閉じること。トップ目でのリーチや仕掛けが結果に結びついている一方、すでに十分なリードがある局では、加点よりも相手の満貫・跳満抽選を消す判断を増やしてよい。テンパイ維持率が高いぶん、本人視点では押せる局が多く見えるはずなので、オーラス前後は局収支より着順価値を重く見る局を少し増やしたい。攻撃力を削る必要はないが、勝ち半荘の事故率をさらに下げれば累計首位はかなり固くなる。",
    ),
    "ひなんじょ": (
